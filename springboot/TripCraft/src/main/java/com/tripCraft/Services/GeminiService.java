...
public class GeminiService {
    ...
    public String buildPrompt(String destination) {
        return String.format("""
            ...
            **unique data ** 
            1. "spots" – Include **all possible unique tourist spots** **at least 30 unique tourist spots** in and around the destination, covering:
               - name
               - location
            ...
            2. "hotels" – **at least 30 unique tourist hotels** Include a range of hotels from low to high budget near the above spots. For each hotel, provide:
               - name
               - location
